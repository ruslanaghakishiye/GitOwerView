...
<script type="text/javascript">
    ...
    if (status == "invalidConfirmPassword"){
        swal("Congrats","Confirm Password not mach","error");
    }
    if (status == "invalidPhone"){
        swal("Congrats","Please Enter Phone","error");
    }
    if (status == "invalidPhoneLenght"){
        swal("Congrats","Phone number should be of 10 digit","error");
    }
</script>
